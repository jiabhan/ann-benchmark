...
int main()
{
    ...
    std::string index_path = std::string(index_dir) + "onng-test/siftsmall";
    std::string result_file = std::string(result_dir) + "onng-test/siftsmall/siftsmall_recall_qps_result.csv";
