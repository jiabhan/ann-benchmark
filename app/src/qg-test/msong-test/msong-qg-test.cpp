...
int main()
{
    ...
    std::string index_data_file = std::string(data_dir) + "millionsong/millionsong_base.fvecs";
    std::string query_data_file = std::string(data_dir) + "millionsong/millionsong_query.fvecs";
    std::string ground_truth_file = std::string(data_dir) + "millionsong/millionsong_groundtruth.ivecs";
    std::string index_path = std::string(index_dir) + "qg-test/millionsong-test";
    std::string result_file_path = std::string(result_dir) + "qg-test/millionsong/millionsong_recall_qps_result.csv";
