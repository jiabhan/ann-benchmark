...
int main()
{
    try {
        ...
        std::string graph_file_path = std::string(graph_dir) + "nsg-test/sift-test/sift_200nn.graph";
        std::string index_path = std::string(index_dir) + "nsg-test/sift-test/";
        std::string index_file_path = index_path + "sift.nsg";
        std::string result_file_path = std::string(result_dir) + "nsg-test/sift-test/sift_recall_qps_result.csv";
