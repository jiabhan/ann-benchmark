    ...
    const char* ground_truth_path, const char* result_file_path)
{
    ...
    std::vector<unsigned> L_values = { 40, 60, 80, 100, 120, 140, 160, 180, 200 };
    unsigned K = 10;
...
int main()
{
    try {
        ...
        std::string graph_file_path = std::string(graph_dir) + "nsg-test/gist-test/gist_200nn.graph";
        std::string index_path = std::string(index_dir) + "nsg-test/gist-test/";
        std::string index_file_path = index_path + "gist.nsg";
        std::string result_file_path = std::string(result_dir) + "nsg-test/gist-test/gist_recall_qps_result.csv";
